...
fit_schoolfield.tleaf_gam <- function(data, x_var, y_var,  T_ref = 25, start_params) {
...
fit_results_schoolfield.tleaf <- fit_schoolfield.tleaf_gam(data, "tleaf", "photo", T_ref = 25, start_params = start_params)

summary(fit_results_schoolfield.tleaf$gam_fit)
