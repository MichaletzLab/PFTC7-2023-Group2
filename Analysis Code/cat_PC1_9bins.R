...
deriv_eW  <- finite_diff_deriv_overall(gam_mod_WUE_PC1)  # NEW
...
dEw <- plot_deriv_overall(deriv_eW, "WUE")  # NEW

# =========================================================
# --- Combine All Plots (5 on top, 5 derivatives below)
# =========================================================
final_plot <- ggarrange(
  ggarrange(pA, pE, pG, pEw,pI, ncol = 3, nrow = 2,
            labels = c("A", "B", "C", "D", "E"),
            common.legend = TRUE, legend = "right"),
  ggarrange(dA, dE, dG, dEw, dI, ncol = 3, nrow = 2,
            labels = c("F", "G", "H", "I", "J")),
